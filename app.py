...
html_temp = """
   ...
   <div class="clearfix">           
   <div class="col-md-12">
   <center><p style="font-size:40px;color:yellow;margin-top:10px;">Kamal Restaurent</p></center> 
   <center><p style="font-size:30px;color:yellow;margin-top:10px;">FOOD REVIEW</p></center> 
   <right><p style="font-size:25px;color:white;margin-top:10px;">My Internship Project</p></right> 
   </div>
   </div>
   </div>
   """
...
if st.button("About"):
  st.subheader("Developed by Mohit Mudgal")
  st.subheader("Department of Computer Engineering")
html_temp = """
   <div class="" style="background-color:orange;" >
   <div class="clearfix">           
   <div class="col-md-12">
   <center><p style="font-size:20px;color:white;margin-top:10px;">Internship Project Deployment</p></center> 
   </div>
   </div>
   </div>
   """
